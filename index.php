...
// IMPORTANTE: Inclui o model para buscar dados da BD
include 'model.php';

// Buscar conteúdos para mostrar na home (limitado a 3 de cada)
                    ...
                    <div class="palestra-card">
                        ...
                        <div class="card-body">
                            <?php if (!empty($palestra['Info_Extra'])): ?>
                                <p><?php echo htmlspecialchars(mb_substr($palestra['Info_Extra'], 0, 100)); ?>...</p>
                            <?php endif; ?>
